...
def build_exam(with_answers=False):
    ...
    essay4 = [
        ...
        "犹如畅饮了琼浆，轻盈，娇媚。",
        "②四月中旬的一个下午，正写得如醉如痴，电话响了。是妈妈打来的。她说，我就在你楼下，下雪了，"
        "我来给你送伞，今天早点回家吃饭吧。",
        "③没有比写到亢奋处遭受打扰更让人不快的了。我终于忍耐不住了，冲妈妈无理地说：“你也是，来之前怎么不打个电话，"
        "问问我需不需要伞？我不要伞，你回去吧！”",
        "④我跑到阳台，看见飞雪中的母亲撑着一把天蓝色的伞，微弓着背，缓缓地朝回走。她的腋下夹着一把绿伞，"
        "那是为我准备的啊。我想喊住她，但羞愧使我张不开口，只是默默地看着她渐行渐远。",
        "⑤做母亲的，怕的就是这样的泪痕会淋湿她的女儿啊！而我却粗暴地践踏了这份慈爱！母爱就像伞，"
        "把阴晦留给自己，而把晴朗留给儿女。",
    ]
    for para in essay4:
        add_p(doc, para, font="楷体", indent=0.74)
    ...
    add_p(doc, "22. 第⑤段把母爱比作“伞”，与课内《荷叶·母亲》中“母亲是荷叶，我是红莲”相比，"
               "都用了比喻，但表达效果有何不同？")
    if with_answers:
        add_p(doc, "【答案】《荷叶·母亲》以荷叶庇护红莲，突出母爱的庇护与守护；"
                       "本文以伞遮挡风雨，突出母亲把艰难留给自己、把晴朗留给儿女的无私。（3分）")
